...
public class LoginRouter {
    ...
    public RouteLocator routeLocator(RouteLocatorBuilder builder) {
        ...
        return builder.routes()
                ...
                .filters(f-> {
                    return f.modifyResponseBody(String.class, String.class, (exchange, result) -> {
                        ...
                        if (jsonObject.containsKey(GatewayConstant.ACCESS_TOKEN)) {
                            ...
                            // 存入redis
                            redisTemplate.opsForValue().set(GatewayConstant.BEARER + token, "", expireTime, TimeUnit.SECONDS);
                        }
